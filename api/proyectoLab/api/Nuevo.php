...

{
  ...
  // $idLab = $MySQLiconn->real_escape_string($_POST['id']);
     ...
     //"UPDATE laboratorio SET Nombre ='$NombreLab', descripcion ='$DescripcioLab', codigo ='$CodigoLab', edificio ='$EdificioLab', numero_aula ='$NumeroAula',foto ='$FotoLab',carrera_idcarrera ='$Carrera', Hora_idHora ='$HoraLab' WHERE idlaboratorio ='$idLab'"



     //"UPDATE laboratorio SET nombre='$nombre', telefono='$telefono', email='$email' WHERE idUsuario='$idUsuario'"
...
//WHERE idlaboratorio".$_GET['editar']
